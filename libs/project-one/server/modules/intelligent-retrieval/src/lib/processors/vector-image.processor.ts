...
export type ImageVectorQueueType = Queue<ChannelImageWithTenantType, boolean, string>
export type ImageVectorJobType = Job<ChannelImageWithTenantType, boolean, string>
