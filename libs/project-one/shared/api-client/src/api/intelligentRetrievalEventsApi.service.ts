...
export class IntelligentRetrievalEventsApiService {
     ...
     */
    public eventControllerCreate(createIntelligentRetrievalEventRequestDto: CreateIntelligentRetrievalEventRequestDto, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<IntelligentRetrievalEventEntity>;
    public eventControllerCreate(createIntelligentRetrievalEventRequestDto: CreateIntelligentRetrievalEventRequestDto, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<IntelligentRetrievalEventEntity>>;
    public eventControllerCreate(createIntelligentRetrievalEventRequestDto: CreateIntelligentRetrievalEventRequestDto, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<IntelligentRetrievalEventEntity>>;
    public eventControllerCreate(createIntelligentRetrievalEventRequestDto: CreateIntelligentRetrievalEventRequestDto, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (createIntelligentRetrievalEventRequestDto === null || createIntelligentRetrievalEventRequestDto === undefined) {
            throw new Error('Required parameter createIntelligentRetrievalEventRequestDto was null or undefined when calling eventControllerCreate.');
        }
