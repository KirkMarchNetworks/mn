...
import { AiMenuItemComponent } from './components/ai-menu-item/ai-menu-item.component';

@Component({
  selector: 'lib-intelligent-retrieval-list',
  standalone: true,
...
export class ListComponent {
  ...
  tableau = new TableauInput<ChannelImageWithDistanceEntity>({
    ...
    menuItemStart: AiMenuItemComponent,
