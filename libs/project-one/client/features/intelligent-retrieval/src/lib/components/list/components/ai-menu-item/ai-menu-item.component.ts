...
@Component({
  selector: 'lib-intelligent-retrieval-ai-menu-item',
  standalone: true,
  imports: [
    CommonModule,
    MatIconButton,
  ...
  templateUrl: './ai-menu-item.component.html',
  styleUrl: './ai-menu-item.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AiMenuItemComponent implements OnInit, OnDestroy {
